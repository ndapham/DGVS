...
# overlay = cv2.imread('/Users/nguyenduy/Desktop/pcgvs-main/notebooks/Metadata/synopsis/patches/6_444.jpg')
# background = cv2.imread('/Users/nguyenduy/Desktop/pcgvs-main/notebooks/Metadata/synopsis/background.jpg')
# rows,cols,channels = overlay.shape  
# overlay=cv2.addWeighted(background[0:rows, 0:cols],0.5,overlay,0.5,0)
# background[0:rows, 0:cols ] = overlay
# cv2.imshow(overlay)
